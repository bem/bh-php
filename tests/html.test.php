...
class htmlTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_it_should_return_bemjson_html()
    {
    ...
    public function test_it_should_set_bemjson_html()
    {
    ...
    public function test_it_should_not_override_user_html()
    {
        $this->bh->match('icon', function ($ctx) {
            $ctx->html('<i>&nbsp;</i>');
        });
